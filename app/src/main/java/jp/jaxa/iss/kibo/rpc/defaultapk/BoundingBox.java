...
public final class BoundingBox {
    private final float x1;        // 左上隅のx座標
    private final float y1;        // 左上隅のy座標
    private final float x2;        // 右下隅のx座標
    private final float y2;        // 右下隅のy座標
    private final float cx;        // バウンディングボックスの中心x座標
    private final float cy;        // バウンディングボックスの中心y座標
    private final float w;         // バウンディングボックスの幅
    private final float h;         // バウンディングボックスの高さ
    private final float cnf;       // 確信度
    private final int cls;         // クラスID
    private final String clsName;  // クラス名
